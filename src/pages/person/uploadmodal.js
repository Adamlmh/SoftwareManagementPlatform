        ...
        <>
            ...
            <Modal title="上传我的软件" width={600} open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
                ...
                >
                    ...
                    >
                        <Input className={styles.shangchuan} ref={softwareNameRef} placeholder='软件名字' />
                    </Form.Item>
                    ...
                    {imageBox && <div className={styles.preview}>
                        <Button className={styles.cancel} onClick={cancelPreview}>x</Button>
